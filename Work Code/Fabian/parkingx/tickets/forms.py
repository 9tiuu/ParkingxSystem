...
class UsuarioForm(UserCreationForm):
    class Meta:
        ...
        widgets = {
            'username': forms.TextInput(attrs={'class': 'form-control form-crud'}),
            'name': forms.TextInput(attrs={'class': 'form-control form-crud'}),
            'last_name': forms.TextInput(attrs={'class': 'form-control form-crud'}),
            'rut': forms.TextInput(attrs={'class': 'form-control form-crud'}),
